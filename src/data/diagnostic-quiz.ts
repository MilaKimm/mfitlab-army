...
export const questions: Question[] = [
  {
    ...
    choices: [
      { id: "a", text: "AI 검색(ChatGPT, Perplexity)에서 우리 브랜드가 안 나옴", scores: [{ solution: "geo", points: 5 }, { solution: "lmf", points: 1 }] },
      { id: "b", text: "광고 소재 제작이 느려서 캠페인 타이밍을 놓침", scores: [{ solution: "lmf", points: 5 }] },
      { id: "c", text: "트래픽은 오는데 전환율이 낮음", scores: [{ solution: "cro", points: 5 }, { solution: "lead-magnet", points: 2 }] },
      { id: "d", text: "인바운드 리드 응대가 느려서 이탈이 많음", scores: [{ solution: "voice", points: 5 }, { solution: "cro", points: 1 }] },
    ],
  },
  {
    id: 2,
